...
export const Home = () => {
    ...
    return <div>
        ...
        <span className='forget-busy-work'>
          ...
          holiday with friends. Time to make another <br/>
          memorable moments.
        </span>
            <Link to={'/catalogue'}  className='bg-4'>
